...
pub struct NativeFns {
    ...
    pub rb_enc_associate_index: unsafe extern "C" fn(VALUE, c_int) -> VALUE,
    pub rb_utf8_encindex: unsafe extern "C" fn() -> c_int,
    ...
    pub rb_ary_new_capa: unsafe extern "C" fn(c_long) -> VALUE,
    ...
    pub fn open(ruby: &Path) -> Result<Ruby, String> {
        ...
        let native = unsafe {
            NativeFns {
                ...
                rb_enc_associate_index: load_sym(handle, b"rb_enc_associate_index\0")?,
                rb_utf8_encindex: load_sym(handle, b"rb_utf8_encindex\0")?,
                ...
                rb_ary_new: load_sym(handle, b"rb_ary_new\0")?,
                rb_ary_new_capa: load_sym(handle, b"rb_ary_new_capa\0")?,
                rb_ary_push: load_sym(handle, b"rb_ary_push\0")?,
