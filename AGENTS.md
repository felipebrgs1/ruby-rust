...
Chatwoot revalidado: Private_Dirty do child **−58%** (era −46% no legado)).
Ciclo L–S fechado; próximos candidatos: APIs nativas novas (`calisto.*`
além de hash/sqlite), degraus reais com o instalado, snapshot gated se o
cenário de privilégio mudar.
